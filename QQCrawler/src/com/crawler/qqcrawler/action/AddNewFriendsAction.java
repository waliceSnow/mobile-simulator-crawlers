...
public class AddNewFriendsAction extends Action {
    ...
    private void addNewFriends() {
        UiSelector addButtonSelector = new UiSelector().className("android.widget.Button").text("同意");
    ...
    private void addNewFriend(String nickName) {
        ...
        // back to last page.
        try {
            UiObject addFriendButton = new UiObject(new UiSelector().text("同意"));
